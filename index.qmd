...
format: 
  dashboard:
    ...
    nav-buttons: [github]
    github: https://github.com/CozminaSecula/dashboard
execute: 
  echo: false
---
...
fig_sal_incr_role <- ggplot(role_salary_increase_n, aes(x=prtc, y=job_title, fill=salary_increase_interval))+
  ...
  theme(legend.position = "top", legend.justification = "left", legend.text = element_text(size = 14),
    ...
    labs(y="Role",
         x="Percent of Total",
         title ="The percentage of employees who received a salary increase for each salary increase interval by role.",
...
fig_sal_incr_exp <- ggplot(experience_salary_increase_n, aes(x=prtc, y=job_level, fill=salary_increase_interval))+
  ...
  theme(legend.position = "top", legend.justification = "left", legend.text = element_text(size = 14),
    ...
    labs(y="Experience Level",
         x="Percent of Total",
         title ="The percentage of employees who received a salary increase for each salary increase interval by experience level.",
         fill= "Salary Increase Interval")+
    facet_grid(dept ~., scales = "free_y", space = "free_y", switch = "y")
...
fig_sal_incr_generation <- ggplot(generation_salary_increase_n, aes(x=prtc, y=generation, fill=salary_increase_interval))+
  ...
  theme(legend.position = "top", legend.justification = "left", legend.text = element_text(size = 14),
    ...
    labs(y="Generation",
         x="Percent of Total",
         title ="The percentage of employees who received a salary increase for each salary increase interval by generation.",
         fill= "Salary Increase Interval")+
    facet_grid(dept ~., scales = "free_y", space = "free_y", switch = "y")
...
fig_sal_incr_gender <- ggplot(gender_salary_increase_n, aes(x=prtc, y=gender, fill=salary_increase_interval))+
  ...
  theme(legend.position = "top", legend.justification = "left", legend.text = element_text(size = 14),
    ...
    labs(y="Gender",
         x="Percent of Total",
         title ="The percentage of employees who received a salary increase for each salary increase interval by gender.",
         fill= "Salary Increase Interval")+
  facet_grid(dept ~., scales = "free_y", space = "free_y", switch = "y")
...
fig_comp_distb <- ggplot(data_annual_interval, aes(y= Cnt, x=annual_interval, fill=annual_interval))+
  geom_bar(stat = "identity", position = "dodge", width = 0.6, fill= "#E5E5E5")+
  geom_text(aes(label=Cnt), hjust= 1, size=6)+
...
dept_comp_n$dept <- gsub(" ", "\n", dept_comp_n$dept)

fig_comp_dept <- ggplot(dept_comp_n, aes(x= dept, y= annual_interval, fill = Count)) +
  geom_tile() + 
  ...
  theme(legend.position = "right", 
        ...
        panel.background = element_blank(),
        panel.grid = element_blank())+
  labs( title = 'The company has a significant number of employees in the middle compensation intervals. **842 (68.28%) of employees earn between 100k-200k** while fewer employees fall into the highest compensation interval. <br /><br />',
        subtitle = 'Distribution of employees across compensation intervals and departments', 
       y= 'Compensation Interval', 
       x= '') +
...
job_title_comp_n$job_title <- gsub(" ", "\n", job_title_comp_n$job_title)

fig_comp_role <- ggplot(job_title_comp_n, aes(x= job_title, y= annual_interval, fill = Count)) +
  geom_tile() + 
  coord_cartesian()+
  geom_text(aes(label=Count), vjust= 0.5, hjust= 0.5, size=5)+
  theme_minimal(base_size = 10)+
...
fig_comp_expr <- ggplot(job_level_comp_n,aes(x= job_level, y= annual_interval, fill = Count)) +
  geom_tile() + 
  geom_text(aes(label=Count), vjust= 0.5, hjust= 0.5, size=5)+
  coord_fixed()+
  theme_minimal(base_size = 10)+
...
fig_comp_generation <- ggplot(comp_gen,aes(x= generation, y= annual_interval, fill = Count)) +
  geom_tile() + 
  geom_text(aes(label = Count), vjust = 0.5, hjust = 0.5, size=5)+
  coord_fixed()+
  theme_minimal(base_size = 10)+
...
fig_comp_gender <- ggplot(comp_gender,aes(x= gender, y= annual_interval, fill = Count)) +
  geom_tile() + 
  geom_text(aes(label = Count), vjust = 0.5, hjust = 0.5, size=5)+
  coord_fixed()+
  theme_minimal(base_size = 10)+
